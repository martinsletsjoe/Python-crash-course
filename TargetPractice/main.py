...
class TargetPractice:
    ...
    def __init__(self):
        ...
        self.misses = 0 # Initialize the missed targets count
    ...
    def _update_aliens(self):
        ...
        # # Look for alien-ship collisions and missed targets.
        # for alien in self.aliens.sprites():
        #     if pygame.sprite.spritecollideany(self.ship, self.aliens):
        #         self.ship_hit()
        #     elif alien.rect.bottom >= self.screen_rect.bottom:
        #         self.misses += 1
        # if self.misses >= 3:
        #     self.game_active = False
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.topright = self.screen_rect.topright
        #
